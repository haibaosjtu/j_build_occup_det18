...
\definecolor{feb18rev}{rgb}{0.8, 0, 0}
...
\begin{abstract}
  ...
  source information. The new method can be used for energy reduction and
  security monitoring for emerging smart buildings. Our work is based
  on a building simulation program, EnergyPlus, from
  Department of Energy. EnergyPlus can model various time-series
  ...
  support vector regression (SVR) and recurrent neural network
  (RNN). Experimental results with SVR show that the
  4-feature model provides accurate detection rate giving a 0.638
  average error and 5.32\% error rate, and the 5-feature model delivers
  ...
  errors greater than 0.5. Our study further shows that both methods
  deliver similar accuracy in the occupancy detection. \textcolor{feb18rev}{But the SVR
  model is more stable for adding or removing features of the system, while the
