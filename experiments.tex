...
\begin{table}[!h]
    ...
    \begin{tabular}{lrrcrrcrr}
        ...
        \bottomrule
    \end{tabular}
    \caption{Validation error statistics of SVR model using different numbers
    of features.}
    \label{table:testing}
\end{table}
...
\caption{Occupancy estimation accuracy when $C$ equals 100 using SVR with 4
    features and 5 features. \textcolor{feb18rev}{X-axis spans over 360 hours (15 days), sampled
