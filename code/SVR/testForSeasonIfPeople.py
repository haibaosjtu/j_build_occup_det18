...
#    
data = [[0 for x in range(5)] for x in range(2880)] 
...
print 'test process for season\n'

#clf = SVR(C=1000, epsilon=0.001)
...
#temp2Copy=temp2
plt.plot(testLabelCopy, 'r', label='EnergyPlus',linewidth=2)
#plt.plot(temp1, c='b', label='Linear model')
plt.plot(temp2Copy, 'k*-', label='SVR')
