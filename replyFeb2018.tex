...
the motivation and contributions of this work. We also added a list of
major contributions at the end of Section \ref{sec:intro} to
highlight the contributions and the novelty of the proposed works.
...
Answer: Thanks for your comments. We have reviewed more existing works and highlighted
our contributions in light of those existing works in the introduction
Section \ref{sec:intro} of this revision.
...
Besides, comparing to the referencing results, the detection accuracy
...
proposed method at the end of experimental section
...
contributions at the end of introduction section to make our
