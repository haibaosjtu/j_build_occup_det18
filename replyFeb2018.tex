...
problem as it is a widely used tradtional machine learning
...
We have update the sectoin xxx to add this comparison discussions (TODO).
...
\ref{fig:comparison}. To remedy this, we added a new figure~\ref{xxxx}
